...
def click_and_crop(event, x, y, flags, param):
    ...
    if event == cv2.EVENT_LBUTTONDOWN:
        ...
        refPt.append((x, y))
        cv2.circle(image, (x,y), 1, the_color, -1)

        if len(refPt) == 4:
            cv2.line(image, refPt[0], refPt[1], (22,22,22), 1)
            cv2.line(image, refPt[1], refPt[3], (22,22,22), 1)
            cv2.line(image, refPt[0], refPt[2], (22,22,22), 1)
